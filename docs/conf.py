...
latex_documents = [
    (master_doc, 'crowdsource.tex', 'crowdsource Documentation',
     'Tim Paine', 'manual'),
]
...
man_pages = [
    (master_doc, 'crowdsource', 'crowdsource Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'crowdsource', 'crowdsource Documentation',
     author, 'crowdsource', 'One line description of project.',
     'Miscellaneous'),
]
...
def run_apidoc(_):
    ...
    crowdsource_dir = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', 'crowdsource'))

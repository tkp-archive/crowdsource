...
# -*- coding: utf-8 -*-
#
# crowdsource documentation build configuration file, created by
...
_version_py = os.path.join("..", "crowdsource", "_version.py")
version_ns = {}
...
htmlhelp_basename = "crowdsourcedoc"
...
latex_documents = [
    (master_doc, "crowdsource.tex", "crowdsource Documentation", "Tim Paine", "manual"),
]
...
man_pages = [(master_doc, "crowdsource", "crowdsource Documentation", [author], 1)]
...
def run_apidoc(_):
    ...
    crowdsource_dir = os.path.abspath(
        os.path.join(os.path.dirname(__file__), "..", "crowdsource")
    )
    ...
    subprocess.check_call(
        [cmd_path, "-E", "-M", "-o", out_dir, crowdsource_dir, "--force"]
    )
